        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('elasticsearch.data.index')}}">Data</a></li>
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="d-flex">
                            ...
                            <button type="button" class="btn btn-success me-2 update" style="display:none;"
                                data-id="{{$data->id}}"
                                data-url="{{route('elasticsearch.data.update', $data->id)}}">Update</button>
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="queryInfoLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="{{route('elasticsearch.data.delete', $data->id)}}" method="POST">
                    @csrf
                    @method('DELETE')
                    <button class="btn btn-primary" type="button" data-bs-dismiss="modal">Close</button>
