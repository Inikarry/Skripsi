...
<div class="container-fluid">
    <div class="page-title">
        <div class="row">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/"> <i data-feather="server"></i></a></li>
                    <li class="breadcrumb-item">Query Logs</li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header pb-0">
                    <h5>Complex headers (rowspan and colspan) </h5><span>When using tables to display data, you will
                        often
                        wish to display column information in groups. DataTables fully supports <code>colspan</code>
                        and<code>rowspan</code> in the table's header, assigning the required order listeners to the TH
                        element suitable for that column.</span><span>
                        Each column must have one TH cell which is unique to it for the listeners to be added. By
                        default
                        DataTables will use the bottom unique cell for the column
                        ...
                        can be used to tell
                        DataTables to use the top cell if you prefer.</span><span>The example shown below has two sets
                        of
                        grouped information, grouped by colspan in the header.</span>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="display" id="basic-6">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>$170,750</td>
                                    <td>Tokyo</td>
                                    <td class="action"> <a class="pdf" href="../assets/pdf/sample.pdf"
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <h5>State saving</h5><span>
                        ...
                        ordering
                        state etc) so that is can be restored when the user
                        reloads a page, or comes back to the page after visiting a sub-page. This state saving ability
                        is
                        enabled by the <code class="option" title="DataTables initialisation option">stateSave</code>
                        option.</span><span>The built in state saving method uses the HTML5 <code>localStorage</code>
                        and
                        ...
                        note that this means that the built in state saving option <strong>will not work with
                            IE6/7</strong>
                        as these browsers do not support these APIs. Alternative
                        ...
                        options.</span><span>The
                        duration for which the saved state is valid and can be used to restore the table state can be
                        set
                        using the <code class="option" title="DataTables initialisation option">stateDuration</code>
                        initialisation
                    ...
                    <div class="table-responsive">
                        <table class="display" id="basic-9">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>Vivian Harrell</td>
                                    <td><span class="badge rounded-pill badge-light-primary">Financial Controller</span>
                                    </td>
                                    <td>San Francisco</td>
                                    <td>62</td>
                                    <td>2009/02/14</td>
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header pb-0">
                    <h5>Scroll - vertical, dynamic height</h5><span>This example shows a vertically scrolling DataTable
                        that makes use of the CSS3 vh unit in order to dynamically resize the viewport based on the
                        browser
                        window height. The vh unit is effectively a percentage of the browser window height. So the 50vh
                        used in this example is 50% of the window height. The viewport size will update dynamically as
                        the
                        window is resized.</span><span>A relatively modern browser is required for vh units to operate
                        correctly. IE9+ supports the vh unit and all other evergreen browsers.</span>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="display" id="basic-12">
                            ...
                            <tbody>
                                <tr>
                                    <td> <img class="img-fluid table-avtar" src="../assets/images/user/2.png"
                                            alt="">Tiger Nixon
                                    </td>
                                    <td>System Architect</td>
                                    <td>Edinburgh</td>
                                ...
                                <tr>
                                    <td> <img class="img-fluid table-avtar" src="../assets/images/user/3.png"
                                            alt="">Ashton Cox
                                    </td>
                                    <td>Junior Technical Author</td>
                                    <td>San Francisco</td>
                                ...
                                <tr>
                                    <td> <img class="img-fluid table-avtar" src="../assets/images/user/3.jpg"
                                            alt="">Cedric Kelly
                                    </td>
                                    <td>Senior Javascript Developer</td>
                                    <td>Edinburgh</td>
                                ...
                                <tr>
                                    <td> <img class="img-fluid table-avtar" src="../assets/images/user/1.jpg"
                                            alt="">Airi Satou
                                    </td>
                                    <td>Accountant</td>
                                    <td>Tokyo</td>
                                ...
                                <tr>
                                    <td> <img class="img-fluid table-avtar" src="../assets/images/user/3.jpg" alt="">Dai
                                        Rios</td>
                                    <td>Personnel Lead</td>
                                    <td>Edinburgh</td>
                                    <td>35</td>
