                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="d-flex">
                            ...
                            <button type="button" class="btn btn-success me-2 update"
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-md-2">
                                        ...
                                        <input class="form-control data-bio" type="text" id="FT8" disabled value="{{$data->FT8}}">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label">FC6</label>
                                        <input class="form-control data-bio" type="text" id="FC6" disabled value="{{$data->FC6}}">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label">FC5</label>
                                        <input class="form-control data-bio" type="text" id="FC5" disabled value="{{$data->FC5}}">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label">FC2</label>
                                        <input class="form-control data-bio" type="text" id="FC2" disabled value="{{$data->FC2}}">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label">FCz</label>
                                        <input class="form-control data-bio" type="text" id="FCz" disabled value="{{$data->FCz}}">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label">Cz</label>
                                        <input class="form-control data-bio" type="text" id="Cz" disabled value="{{$data->Cz}}">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-md-2">
                                        ...
                                        <input class="form-control data-bio" type="text" id="C2" disabled value="{{$data->C2}}">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label">C4</label>
                                        <input class="form-control data-bio" type="text" id="C4" disabled value="{{$data->C4}}">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label">C6</label>
                                        <input class="form-control data-bio" type="text" id="C6" disabled value="{{$data->C6}}">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label">T8</label>
                                        <input class="form-control data-bio" type="text" id="T8" disabled value="{{$data->T8}}">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label">TP8</label>
                                        <input class="form-control data-bio" type="text" id="TP8" disabled value="{{$data->TP8}}">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label">CP6</label>
                                        <input class="form-control data-bio" type="text" id="CP6" disabled value="{{$data->CP6}}">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-md-2">
                                        ...
                                        <input class="form-control data-bio" type="text" id="CP4" disabled value="{{$data->CP4}}">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label">CP2</label>
                                        <input class="form-control data-bio" type="text" id="CP2" disabled value="{{$data->CP2}}">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label">P2</label>
                                        <input class="form-control data-bio" type="text" id="P2" disabled value="{{$data->P2}}">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label">P4</label>
                                        <input class="form-control data-bio" type="text" id="P4" disabled value="{{$data->P4}}">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label">P6</label>
                                        <input class="form-control data-bio" type="text" id="P6" disabled value="{{$data->P6}}">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label">P8</label>
                                        <input class="form-control data-bio" type="text" id="P8" disabled value="{{$data->P8}}">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-md-2">
                                        ...
                                        <input class="form-control data-bio" type="text" id="P10" disabled value="{{$data->P10}}">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label">PO8</label>
                                        <input class="form-control data-bio" type="text" id="PO8" disabled value="{{$data->PO8}}">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label">PO4</label>
                                        <input class="form-control data-bio" type="text" id="PO4" disabled value="{{$data->PO4}}">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label">O2</label>
                                        <input class="form-control data-bio" type="text" id="O2" disabled value="{{$data->O2}}">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label">VEOa</label>
                                        <input class="form-control data-bio" type="text" id="VEOa" disabled value="{{$data->VEOa}}">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label">VEOb</label>
                                        <input class="form-control data-bio" type="text" id="VEOb" disabled value="{{$data->VEOb}}">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row g-3 justify-content-center">
                                    <div class="col-md-2">
                                        ...
                                        <input class="form-control data-bio" type="text" name="HEOL" disabled value="{{$data->HEOL}}">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label">HEOR</label>
                                        <input class="form-control data-bio" type="text" name="HEOR" disabled value="{{$data->HEOR}}">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label">Nose</label>
                                        <input class="form-control data-bio" type="text" name="Nose" disabled value="{{$data->Nose}}">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label">TP10</label>
                                        <input class="form-control data-bio" type="text" name="TP10" disabled value="{{$data->TP10}}">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-2 row">
                    ...
                    <div class="col" id="queryInfoQuery">{{$queryLog[0]['query']}}</div>
                </div>
                <div class="mb-2 row">
